/* af_unix2.c:
 *
* This program creates an socket by means of function "socket"
* and form an AF_UNIX (the same as AF_LOCAL) address.
*
* The difference over Listing 2.3 is that the address of the sicket is abstract
*
*
 ...
 */
 ...
 /*
 * Create an AF_UNIX (aka AF_LOCAL) socket:
 */
