...
// Creating a AF_UNIX (aka AF_LOCAL) socket
...
/*
* Here we remove the pathname for the socket, in case it existed form
* a prior run. Ignore errors (it might not exist)
*/
...
/*
* Close and unlink our sicket path:
*/
